...
export class CrawlerSetup implements CrawlerSetupOptions {
    ...
    private async _requestHandler(crawlingContext: PuppeteerCrawlingContext) {
        ...
        try {
            ...
            if (!page) {
                log.error("Page object is undefined in _requestHandler!");
                await this._failedRequestHandler(request, new Error("Page object is undefined"));
                return; 
            }
    
            const output = await page.evaluate(async (ctxOpts, namespc) => {
                console.log("Entering page.evaluate"); 
                console.log("Namespace:", namespc); 
                ...
                console.log("Calling pageFunction");
                ...
                console.log("pageFunction result:", pageFunctionResult);
                console.log("Exiting page.evaluate");
